...
ALLAPP = ['luindex', 'lusearch', 'fop', 'antlr', 'pmd', 'chart', 'bloat', 'xalan', 'hsqldb', 'eclipse', 'jython',
...
def runDoop(app, analyse):
    ...
    if app in DACAPOAPP:
        cmd = cmd + ' -i benchmarks/dacapo-2006/'+app+'.jar --dacapo --platform java_6 --cs-library --no-merge-library-objects --Xno-ssa'
    else:
